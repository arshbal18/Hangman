...
namespace Hangman
{
    [Activity(Label = "PlayerName")] //DATABSE FOR PLAYER//
    public class Player : Activity
    {
        ...
        private void spinner_ItemSelected(object sender, AdapterView.ItemSelectedEventArgs e)
        {
            ...
            HomeScreen.PlayerName = this.myList.ElementAt(e.Position).Name;
            HomeScreen.score = this.myList.ElementAt(e.Position).Score;
        }
